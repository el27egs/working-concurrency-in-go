...
func (app *Config) PostLoginPage(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		app.Session.Put(r.Context(), "error", "Invalid credentialsA.")
	...
	if err != nil {
		app.ErrorLog.Println(err)
		app.Session.Put(r.Context(), "error", "Invalid credentialsB.")
		http.Redirect(w, r, "/login", http.StatusSeeOther)
		return
	}
	...
	if !validPassword {
		...
		app.sendEmail(msg)
		app.Session.Put(r.Context(), "error", "Invalid credentialsC.")
		http.Redirect(w, r, "/login", http.StatusSeeOther)
		return
	}
...
func (app *Config) PostRegisterPage(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		app.Session.Put(r.Context(), "error", fmt.Sprintf("Unable to create user. %s", err))
